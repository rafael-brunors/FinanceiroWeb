...
public class Usuario implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3980853771407249339L;
	...
	@Override
	public String toString() {
		return "Usuario [" + (codigo != null ? "codigo=" + codigo + ", " : "")
				+ (nome != null ? "nome=" + nome + ", " : "")
				...
				+ (idioma != null ? "idioma=" + idioma + ", " : "") + "ativo="
				+ ativo + ", "
				+ (permissao != null ? "permissao=" + permissao : "") + "]";
	}
